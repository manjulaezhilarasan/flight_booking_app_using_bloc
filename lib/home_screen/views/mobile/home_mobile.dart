                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    gradient: LinearGradient(
                      colors: [Color(0xff931158), Color(0xff931158)],
                      begin: Alignment.topCenter,
                      end: Alignment.bottomCenter,
                    ),
                  ),
                  padding:
                      EdgeInsets.symmetric(horizontal: 20.0, vertical: 56.0),
                  child: Align(
                  ...
                  child: Container(
                    ...
                    child: FormBuilder(
                      ...
                      onChanged: () {
                        ...
                        context.read<HomeBloc>().add(OnChangeHomeFormValue(
                        ...
                        children: [
                          Row(
                            ...
                            children: [
                              ...
                              FlightTypeButton(
                                  icon: Icons.autorenew, text: "Round Trip"),
                              FlightTypeButton(
                                  icon: Icons.arrow_upward, text: "Multi City"),
                            ],
                          ),
                          FormBuilderDropdown(
                            name: 'from',
